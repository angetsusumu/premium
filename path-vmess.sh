...
old=$(cat /etc/xray/path/vmess_ws_path)
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e " ${red}             ⇱ CHANGE PATH VMESS WS ⇲               ${NC}"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo -e "Please Enter A New Path For Vmess WS"
read -p "New Path : " new
if [ -z $new ]; then
...
sed -i "s#${old}#${new}#g" /etc/nginx/conf.d/vmnone.conf
sed -i "s#${old}#${new}#g" /usr/local/etc/xray/will666.json
sed -i "s#${old}#${new}#g" /etc/xray/path/vmess_ws_path
echo -e ""
