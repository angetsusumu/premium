...
echo -e "Contact Admin : t.me/bento_cok"
rm -rf /tmp/logs.txt
...
old=$(cat /etc/xray/path/vmess_grpc_path)
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e " ${red}             ⇱ CHANGE PATH VMESS GRPC ⇲               ${NC}"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo -e "Please Enter A New Path For Vmess GRPC"
read -p "New Path : " new
if [ -z $new ]; then
...
sed -i "s#${old}#${new}#g" /etc/xray/path/vmess_grpc_path
echo -e ""
