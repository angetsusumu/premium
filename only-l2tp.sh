...
Documentation=https://t.me/bento_cok
...
User=root
Type=simple
ExecStart=/etc/william/udp/udp-custom server -config /etc/william/udp/config.json -exclude 53,5300,2200,7100,7200,7300,1701
Restart=always
RestartSec=3s
