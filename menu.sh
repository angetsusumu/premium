...
data_ip="https://raw.githubusercontent.com/angetsusumu/regip/main/ip"
checking_sc() {
    ...
    if [[ $date_list < $useexp ]]; then
        ...
        echo -e "      \033[0;36mTelegram${NC} t.me/jancok"
        echo -e "      ${GREEN}WhatsApp${NC} wa.me/081234567890"
        echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
        exit
    fi
}
...
#!/bin/bash
Name=$(curl -sS https://raw.githubusercontent.com/angetsusumu/regip/main/ip | grep $MYIP | awk '{print $2}')
MYIP=$(curl -sS ipv4.icanhazip.com)
res=$(curl -sS https://raw.githubusercontent.com/angetsusumu/regip/main/ip | grep $MYIP | awk '{print $3}')
...
repogithub='angetsusumu/premium/main'
clear
# Warna
RED='\033[0;31m'
GREEN='\033[0;32m'
...
# Header Box
echo -e "${COLOR1}╔══════════════════════════════════════════════════════╗${NC}"
echo -e "${COLOR1}║${NC}                  \e[1;35m<< JANCOK TUNNEL >>\e[0m                   ${COLOR1}║${NC}"
echo -e "${COLOR1}╚══════════════════════════════════════════════════════╝${NC}"
