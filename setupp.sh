...
figlet -f small -t "       JANCOK TUNNEL" | lolcat
echo -e "                 ${green}AUTOSCRIPT INSTALLER v1${NC}  -  ${bold}©2020-2023${NC}"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "     ${red}TELEGRAM${NC} : t.me/jancok"
echo -e "     ${red}nomor wa${NC} : 081234567890"
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

# Set opsi langsung ke 2 tanpa input user
opsi="2"
...
echo "###############################" | tee -a log-install.txt
echo "#         JANCOK TUNNEL         #" | tee -a log-install.txt
echo "###############################" | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "---------------------------------------------------------------------"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
...
echo ""   | tee -a log-install.txt
echo "   - Dev/Main                : JANCOK TUNNEL"  | tee -a log-install.txt
echo "   - Telegram                : t.me/jancok"  | tee -a log-install.txt
echo "" | tee -a log-install.txt
echo "=================================================================="  | tee -a log-install.txt
echo " Reboot 15 Sec"
cd /root
